<?= view('layout/header', ['title' => 'Edit Retur']) ?>
<?= view('layout/sidebar') ?>
<div class="main-content">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h4 class="mb-0">Edit Retur: <?= $retur['kode_retur'] ?></h4>
        <a href="retur/detail/<?= $retur['id'] ?>" class="btn btn-secondary"><i class="bi bi-arrow-left"></i> Kembali</a>
    </div>
            ...
            <form action="retur/update/<?= $retur['id'] ?>" method="POST">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <select name="id_sales" class="form-control" required>
                            <?php foreach ($sales_list as $s): ?>
                                <option value="<?= $s['id'] ?>" <?= $retur['id_sales'] == $s['id'] ? 'selected' : '' ?>><?= $s['nama_sales'] ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    <div class="col-md-4 mb-3">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="alasan_retur" class="form-control" value="<?= $retur['alasan_retur'] ?>" required>
                    </div>
                    <div class="col-md-6 mb-3">
                        <label class="form-label">Keterangan</label>
                        <input type="text" name="keterangan" class="form-control" value="<?= $retur['keterangan'] ?>">
                    </div>
                </div>
                <h6 class="mt-3 mb-2">Item Produk Retur</h6>
                <div id="item-container">
                    ...
                    <div class="item-row row mb-2">
                        ...
                        <div class="col-md-5">
                            <input type="number" name="jumlah[]" class="form-control" value="<?= $d['jumlah'] ?>" placeholder="Jumlah" required>
                        </div>
                        <div class="col-md-2">
