<?= view('layout/header', ['title' => 'Input Retur']) ?>
<?= view('layout/sidebar') ?>
<div class="main-content">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h4 class="mb-0">Input Retur dari Warung</h4>
            ...
            <form action="retur/store" method="POST">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="alasan_retur" class="form-control" placeholder="Contoh: Kadaluarsa, Rusak" required>
                    </div>
                    <div class="col-md-6 mb-3">
                ...
                <br>
                <button type="submit" class="btn btn-primary"><i class="bi bi-save"></i> Simpan Retur</button>
            </form>
        </div>
    </div>
</div>
