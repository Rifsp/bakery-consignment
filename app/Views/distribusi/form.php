<?= view('layout/header', ['title' => 'Input Distribusi']) ?>
<?= view('layout/sidebar') ?>
<div class="main-content">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h4 class="mb-0">Input Distribusi ke Warung</h4>
    ...
    <div class="card">
        <div class="card-body">
            <form action="distribusi/store" method="POST">
                ...
                <input type="hidden" name="id_stok_sales" value="">
                <div class="mb-3">
                ...
                <br>
                <button type="submit" class="btn btn-primary"><i class="bi bi-save"></i> Simpan Distribusi</button>
            </form>
        </div>
    </div>
</div>
